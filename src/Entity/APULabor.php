...
class APULabor
{
    ...
    private float $jorHora; // JOR./HORA (Jornada por hora)
    ...
    public function getJorHora(): float
    {
        return $this->jorHora;
    }

    public function setJorHora(float $jorHora): self
    {
    ...
    {
        return $this->jorHora * $this->cHora;
    }
}
